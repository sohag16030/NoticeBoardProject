...
$sql = "select name,batch,dept_name from contacts where id = '$id'";
   ...
   $num = mysqli_num_rows($qry);
	if($num>0) {
		...
		$message = "batch section not found ";
	}
...
$others = $_POST['others'];
 ...
 $sql = "INSERT INTO notice(notice_title,dept_name,course_code,course_title,batch,semester,year,submission_date,publish_schedule
,topics,others
) values('$notice_title','$dept_name','$course_code','$course_title','$batch','$semester','$year','$submission_date',Current_timestamp,'$topics','$others'
)"; 
...
<div class="container">
 ...
 <?php echo "You are the CR of batch - " .$batch. "  and Department - ".$dept_name."  .you can give a notice to your section " ?>
