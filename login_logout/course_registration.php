	     ...
	     <div class="card-body">
	   		...
	   		<div class="row p-3 mb-2 bg-light text-dark">
				  <div class="col-md-8">
						...
						<h6 class = "text-left">	<?php echo "Batch: ",$batch ;?> </h6> 
...
<?php
$sql = "INSERT INTO registration(dept_name,course_code,course_title,semester, year , batch, contacts_id) values('$dept_name','$spec','$speci','$semester','$year','$batch','$id')"; 
