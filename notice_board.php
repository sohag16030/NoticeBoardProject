...
$id =$_SESSION["id"];
 ...
 $query = "SELECT * FROM notice,registration  WHERE notice.batch = registration.batch and notice.course_code=registration.course_code AND registration.contacts_id = '$id' AND notice.dept_name = registration.dept_name order by notice.serial_no DESC LIMIT 6";
...
?>	
	...
	<div  id="accordion">
	  <div class="card" style="border: none;">
		...
		<?php echo "NOTICE PUBLISH DATE : " , $row[9]; ?>
	      </h5>
	    </div>
	     ...
	     <div class="card-body">
	   		...
	   		<div class="row p-3 mb-2 bg-light text-dark">
				  <div class="col-md-8">
						...
						<h6 class = "text-left">	<?php echo "Topics : ", nl2br($row[10]);?> </h6> <br>	
	     		  		
	     		  		<hr>
	     		  		<h5 class = "text-left"><span class="badge badge-pill badge-danger"><?php echo "Important Notice : ", $row[11];?> </span></h5> 	
				  </div>
				 <div class="col-md-4">
					...
					<h6 class = "text-right">	<?php echo "Batch: ", $row[5]?> </h6> 
					<h6 class = "text-right">	<?php echo "Semester : ",$row[6]." - ".$row[7];?> </h6> 
